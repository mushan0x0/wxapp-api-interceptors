    ...
    wx = new Proxy({}, {
        get: function get(receiver, name) {
            ...
            return function () {
                ...
                var handleInterceptors = function () {
                    ...
                    return function handleInterceptors() {
                        return _ref.apply(this, arguments);
                    };
                }();
                if (interceptors[name] && !oldWx.canIUse(name + '.success')) {
                    handleInterceptors(true);
                } else if ((typeof params === 'undefined' ? 'undefined' : (0, _typeof3.default)(params)) === 'object' && oldWx.canIUse(name + '.success') || interceptors[name]) {
